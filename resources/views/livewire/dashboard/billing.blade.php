                        ...
                        <div class="card bg-transparent shadow-xl">
                            <div class="overflow-hidden position-relative border-radius-xl"
                                ...
                                <div class="card-body position-relative z-index-1 p-3">
                                    <i class="fa fa-wifi text-white p-2"></i>
                                ...
                                <div class="card">
                                    <div class="card-header mx-4 p-3 text-center">
                                        <div
                                            ...
                                            <i class="fa fa-landmark opacity-10"></i>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a class="btn bg-gradient-dark mb-0" href="javascript:;"><i
                                                class="fa fa-plus"></i>&nbsp;&nbsp;Add New Card</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-md-0 mb-4">
                                        <div
                                            ...
                                            <i class="fa fa-pencil-alt ms-auto text-dark cursor-pointer"
                            ...
                            <li
                                ...
                                <div class="d-flex align-items-center text-sm">
                                    ...
                                    <button class="btn btn-link text-dark text-sm mb-0 px-0 ms-4"><i
                                            class="fa fa-file-pdf text-lg me-1"></i> PDF</button>
                                </div>
                            </li>
                            <li
                                class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                            ...
                            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                ...
                                <div class="ms-auto">
                                    ...
                                    <a class="btn btn-link text-dark px-3 mb-0" href="javascript:;"><i
                                            class="fa fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                                </div>
                            </li>
